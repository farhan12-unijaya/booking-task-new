...
@include('components.bs.textarea', [
	...
	'mode' => 'disabled',
	'value' => $kpks->province_office->address->address1.
	    ($kpks->province_office->address->address2 ? ', '.$kpks->province_office->address->address2 : '').
	    ($kpks->province_office->address->address3 ? ', '.$kpks->province_office->address->address3 : '').
	    ', '.
	    $kpks->province_office->address->postcode.' '.
	    ($kpks->province_office->address->district ? $kpks->province_office->address->district->name : '').', '.
	    ($kpks->province_office->address->state ? $kpks->province_office->address->state->name : '')
])
