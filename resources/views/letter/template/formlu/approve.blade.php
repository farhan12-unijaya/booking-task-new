...
@include('components.bs.date', [
	'name' => 'tenure',
	'label' => 'Bagi Penggal',
	'value' => $letter->entity->tenures->last()->start_year.'/'.$letter->entity->tenures->last()->end_year
])
...
@include('components.bs.input', [
	'name' => 'branch_name',
	'label' => 'Nama Cawangan Kesatuan',
	'mode' => 'disabled',
	'value' => $letter->filing->branch ? $letter->filing->branch->name : ''
])
