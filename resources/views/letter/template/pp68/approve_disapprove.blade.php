...
@include('components.bs.textarea', [
	...
	'label' => 'Pengecualian yang diluluskan',
    'value' => array_key_exists('approved_conditions',$data) ? $data['approved_conditions'] : ''
])

@include('components.bs.textarea', [
	'name' => 'disapproved_conditions',
	'label' => 'Pengecualian yang tidak diluluskan',
    'value' => array_key_exists('disapproved_conditions',$data) ? $data['disapproved_conditions'] : ''
])
