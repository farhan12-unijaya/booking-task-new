...
@include('components.bs.textarea', [
	...
	'label' => 'Alamat',
	'mode' => 'disabled',
	'value' => $letter->filing->new_address->address1.
	    ($letter->filing->new_address->address2 ? ', '.$letter->filing->new_address->address2 : '').
	    ($letter->filing->new_address->address3 ? ', '.$letter->filing->new_address->address3 : '').
	    ', '.
	    $letter->filing->new_address->postcode.' '.
	    ($letter->filing->new_address->district ? $letter->filing->new_address->district->name : '').', '.
	    ($letter->filing->new_address->state ? $letter->filing->new_address->state->name : '')
])
