                    ...
                    <div class="card card-transparent">
                        <div class="card-block p-t-0">
                            ...
                            <p class="small hint-text m-t-5">
                                Pengurusan notifikasi boleh dilakukan melalui jadual di bawah.
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalTitle">Tambah <span class="bold">Notifikasi</span></h5>
            ...
            <div class="modal-body m-t-20">
                 <form id='form-add' role="form" method="post" action="{{ route('admin.notification') }}">
...
var settings = {
    ...
    "buttons": [
        {
            text: '<i class="fa fa-plus m-r-5"></i> Notifikasi',
...
function edit(id) {
    $("#modal-div").load("{{ route('admin.notification') }}/"+id);
}
...
function remove(id) {
    ...
    .then((confirm) => {
        if (confirm) {
            $.ajax({
                url: '{{ route('admin.notification') }}/'+id,
                method: 'delete',
                dataType: 'json',
                async: true,
                contentType: false,
