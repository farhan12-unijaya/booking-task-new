        ...
        <div class="modal-content-wrapper">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-add-examiner" role="form" method="post" action="{{ route('lockout.formu.examiner', $lockout->id) }}">
...
var settings = {
    ...
    "serverSide": true,
    "deferRender": true,
    "ajax": "{{ route('lockout.formu.examiner', $lockout->id) }}",
    "columns": [
...
function editExaminer(id) {
    $("#modal-div").load("{{ route('lockout.formu.examiner', $lockout->id) }}/"+id);
}
...
function removeExaminer(id) {
    ...
    .then((confirm) => {
        if (confirm) {
            $.ajax({
                url: '{{ route('lockout.formu.examiner', $lockout->id) }}/'+id,
                method: 'delete',
                dataType: 'json',
                async: true,
                contentType: false,
