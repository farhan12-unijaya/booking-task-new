        ...
        <div class="modal-content-wrapper">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-add-examiner" role="form" method="post" action="{{ route('strike.formu.examiner', $strike->id) }}">
...
var settings = {
    ...
    "serverSide": true,
    "deferRender": true,
    "ajax": "{{ route('strike.formu.examiner', $strike->id) }}",
    "columns": [
...
function editExaminer(id) {
    $("#modal-div").load("{{ route('strike.formu.examiner', $strike->id) }}/"+id);
}
...
function removeExaminer(id) {
    ...
    .then((confirm) => {
        if (confirm) {
            $.ajax({
                url: '{{ route('strike.formu.examiner', $strike->id) }}/'+id,
                method: 'delete',
                dataType: 'json',
                async: true,
                contentType: false,
