...
<body class="letter">
	...
	<div class="left">Yuran dibayar dengan setem yang belum dibatalkan <strong>RM 30.00</strong></div>
	<div class="left">Nama Kesatuan Sekerja <strong>{{ $formbb->tenure->entity->name }}</strong></div><br><br><br>
	<table>
		<tr>
			<td></td>
