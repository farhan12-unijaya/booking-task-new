		...
		<div class="modal-content-wrapper">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="form-add-officer" role="form" method="post" action="{{ route('formb.b2.officer') }}" class="is-icpassport">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group form-group-default form-group-default-custom form-group-default-select2">
										...
										<select name="previous_designation_id" class="full-width autoscroll state" data-init-plugin="select2">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group form-group-default required">
										...
										<input name="conviction" type="text" class="form-control" required>
									</div>
								</div>
							</div>
						</div>
...
<script type="text/javascript">
	...
	var settings2 = {
	    ...
	    "serverSide": true,
	    "deferRender": true,
	    "ajax": "{{ route('formb.b2.officer', ['id' => $formb->id]) }}",
	    "columns": [
	...
	function editOfficer(id) {
		if(id == null)
	    	...
	    	$("#modal-div").load("{{ route('formb.b2.officer') }}/"+id);
	}
