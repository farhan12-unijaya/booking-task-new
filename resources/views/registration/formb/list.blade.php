                ...
                <div class="col-xl-12 col-lg-12 ">
                    ...
                    <div class="card card-transparent">
                        <div class="card-block p-t-0">
                            <h3 class='m-t-0'>Senarai <span class="semi-bold">Borang B</span></h3>
                            <p class="small hint-text m-t-5">
                                Pengurusan permohonan Borang B boleh dilakukan melalui jadual di bawah.
                            </p>
                        </div>
                    </div>
                    <!-- END card -->
...
var settings = {
    ...
    "columns": [
        ...
        { data: "union.name", name: "union.name"},
...
function process(id) {
    $("#modal-div").load("{{ route('formb') }}/"+id+"/process/result");
}

function receive(id) {
    $("#modal-div").load("{{ route('formb') }}/"+id+"/process/document-receive");
}

function query(id) {
    $("#modal-div").load("{{ route('formb') }}/"+id+"/process/query");
}

function recommend(id) {
    $("#modal-div").load("{{ route('formb') }}/"+id+"/process/recommend");
}

function category(id) {
    $("#modal-div").load("{{ route('formb') }}/"+id+"/process/category");
}
