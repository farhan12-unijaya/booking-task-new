                ...
                <div class="col-xl-12 col-lg-12 ">
                    ...
                    <div class="card card-transparent">
                        <div class="card-block p-t-0">
                            <h3 class='m-t-0'>Borang E - Permohonan Untuk Membatalkan Sijil Pendaftaran</h3>
                            <p class="small hint-text m-t-5">
                                AKTA KESATUAN SEKERJA, 1959 (Seksyen 15 dan Peraturan 8)
                            </p>
                        </div>
                    </div>
                    <!-- END card -->
...
<div id="rootwizard">
	...
	<ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" {{-- data-init-reponsive-tabs="dropdownfx" --}} >
		...
		<li class="nav-item">
			<a class="" data-toggle="tab" href="#" data-target="#tab2" role="tab"><i class="fa tab-icon {{ $forme->members->count() < 7 ? 'fa-times text-danger' : 'fa-check text-success' }}"></i> <span>Butiran Ahli</span></a>
		</li>
	</ul>
	...
	<div class="tab-content">
		<div class="tab-pane active slide-right" id="tab1">
			@include('dissolution-cancellation.dissolution.forme.tab1')
		</div>
		<div class="tab-pane slide-right" id="tab2">
			@include('dissolution-cancellation.dissolution.forme.tab2.index')
		</div>
	</div>
</div>
@endsection
...
///////////////////////////////////////////////////////////////////////////////////
var required = {
	'applied_at': '{{ $forme->applied_at ? 1 : 0 }}',
	'meeting_type_id': '{{ $forme->meeting_type_id ? 1 : 0 }}',
	'resolved_at': '{{ $forme->resolved_at ? 1 : 0 }}',
}
...
$(document).ready(function(){
	...
	$("#meeting_type_{{ $forme->meeting_type_id ? $forme->meeting_type_id : '' }}").prop('checked', true).trigger('change');;
