        ...
        <div class="modal-content-wrapper">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-add-examiner" role="form" method="post" action="{{ route('formu.examiner', [$dissolution->id]) }}">
...
var settings = {
    ...
    "serverSide": true,
    "deferRender": true,
    "ajax": "{{ route('formu.examiner', [$dissolution->id]) }}",
    "columns": [
...
function editExaminer(id) {
    $("#modal-div").load("{{ route('formu.examiner', [$dissolution->id, $formu->id]) }}/"+id);
}
...
function removeExaminer(id) {
    ...
    .then((confirm) => {
        if (confirm) {
            $.ajax({
                url: '{{ route('formu.examiner', [$dissolution->id]) }}/'+id,
                method: 'delete',
                dataType: 'json',
                async: true,
                contentType: false,
