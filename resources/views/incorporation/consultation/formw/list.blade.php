                ...
                <div class="col-xl-12 col-lg-12 ">
                    ...
                    <div class="card card-transparent">
                        <div class="card-block p-t-0">
                            <h3 class='m-t-0'>Senarai <span class="semi-bold">Borang W</span></h3>
                            <p class="small hint-text m-t-5">
                                Pengurusan Pendaftaran Borang W boleh dilakukan melalui jadual di bawah.
                            </p>
    ...
    <div class="card card-transparent">
        <div class="card-header px-0">
            <div class="card-title">
                ...
                <a href="{{ route('formw') }}" class="btn btn-master text-capitalize btn-success mt-2"><i class="fa fa-plus mr-1"></i> Borang W</a>
                @endif
            </div>
        ...
        <div class="modal-content-wrapper">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="background-color: #f3f3f3;">
                    ...
                    <a href="{{ route('formw') }}" class="btn btn-primary mt-4"><i class="fa fa-edit mr-1 text-capitalize"></i> Kemaskini Borang</a>
                    @endif
...
function process(id) {
    $("#modal-div").load("{{ route('formw') }}/"+id+"/process/result");
}

function receive(id) {
    $("#modal-div").load("{{ route('formw') }}/"+id+"/process/document-receive");
}

function query(id) {
    $("#modal-div").load("{{ route('formw') }}/"+id+"/process/query");
}

function recommend(id) {
    $("#modal-div").load("{{ route('formw') }}/"+id+"/process/recommend");
}
</script>
@endpush
