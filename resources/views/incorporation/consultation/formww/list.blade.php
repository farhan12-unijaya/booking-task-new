                ...
                <div class="col-xl-12 col-lg-12 ">
                    ...
                    <div class="card card-transparent">
                        <div class="card-block p-t-0">
                            <h3 class='m-t-0'>Senarai <span class="semi-bold">Borang WW</span></h3>
                            <p class="small hint-text m-t-5">
                                Pengurusan Pendaftaran Borang WW boleh dilakukan melalui jadual di bawah.
                            </p>
    ...
    <div class="card card-transparent">
        <div class="card-header px-0">
            <div class="card-title">
                @if(auth()->user()->hasAnyRole(['ks', 'pks']))
                <a href="{{ route('formww') }}" class="btn btn-master text-capitalize btn-success mt-2"><i class="fa fa-plus mr-1"></i> Borang WW</a>
                @endif
            </div>
        ...
        <div class="modal-content-wrapper">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="background-color: #f3f3f3;">
                    ...
                    <a href="{{ route('formww') }}" class="btn btn-primary mt-4"><i class="fa fa-edit mr-1 text-capitalize"></i> Kemaskini Borang</a>
                    @endif
...
function process(id) {
    $("#modal-div").load("{{ route('formww') }}/"+id+"/process/result");
}

function receive(id) {
    $("#modal-div").load("{{ route('formww') }}/"+id+"/process/document-receive");
}

function query(id) {
    $("#modal-div").load("{{ route('formww') }}/"+id+"/process/query");
}

function recommend(id) {
    $("#modal-div").load("{{ route('formww') }}/"+id+"/process/recommend");
}
</script>
@endpush
