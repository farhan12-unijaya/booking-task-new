...
<div class="jumbotron m-b-0" data-pages="parallax">
	<div class=" container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
		<div class="inner">
			<!-- START BREADCRUMB -->
			{{ Breadcrumbs::render('formww') }}
			<div class="row">
				<div class="col-xl-12 col-lg-12 ">
					<!-- START card -->
					<div class="card card-transparent">
						<div class="card-block p-t-0">
							<h3 class='m-t-0'>Borang WW - Pemberitahuan penggabungan Kesatuan Sekerja dengan Badan Perunding dalam Malaysia</h3>
							<p class="small hint-text m-t-5">
								Akta Kesatuan Sekerja 1959, Seksyen 76A 2a
							</p>
						</div>
					</div>
					<!-- END card -->
...
<div id="rootwizard">
	...
	<ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" {{-- data-init-reponsive-tabs="dropdownfx" --}} >
		...
		<li class="nav-item">
			<a class="" data-toggle="tab" href="#" data-target="#tab2" role="tab"><i class="fa tab-icon {{ $formww->officers->count() < 5 ? 'fa-times text-danger' : 'fa-check text-success' }}"></i> <span>Butiran Pegawai</span></a>
		</li>
	</ul>
	...
	<div class="tab-content">
		<div class="tab-pane active slide-right" id="tab1">
			@include('incorporation.consultation.formww.tab1')
		</div>
		<div class="tab-pane slide-right" id="tab2">
			@include('incorporation.consultation.formww.tab2.index')
		</div>
	</div>
</div>
@endsection
...
///////////////////////////////////////////////////////////////////////////////////
var required = {
	'consultant_name': '{{ $formww->consultant_name ? 1 : 0 }}',
	'consultant_address': '{{ $formww->consultant_address ? 1 : 0 }}',
	'consultant_phone': '{{ $formww->consultant_phone ? 1 : 0 }}',
	'consultant_fax': '{{ $formww->consultant_fax ? 1 : 0 }}',
	'consultant_email': '{{ $formww->consultant_email ? 1 : 0 }}',
	'resolved_at': '{{ $formww->resolved_at ? 1 : 0 }}',
	'meeting_type_id': '{{ $formww->meeting_type_id ? 1 : 0 }}',
	'applied_at': '{{ $formww->applied_at ? 1 : 0 }}',
}
...
$(document).ready(function(){
    ...
    $('#tab1 input[type=text], #tab1 input[type=email], #tab1 input[type=radio], #tab1 input[type=checkbox], #tab1 select, #tab1 textarea').on('change', function() {
        socket.emit('formww', {
            id: {{ $formww->id }},
            name: $(this).attr('name'),
    ...
    $("#meeting_type_{{ $formww->meeting_type_id }}").prop('checked', true).trigger('change');
});
</script>
@endpush
