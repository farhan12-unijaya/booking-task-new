                ...
                <div class="col-xl-12 col-lg-12 ">
                    ...
                    <div class="card card-transparent">
                        <div class="card-block p-t-0">
                            <h3 class='m-t-0'>Senarai <span class="semi-bold">Laporan Permohonan Semakan Kehakiman / Affidavit Jawapan</span></h3>
                            <p class="small hint-text m-t-5">
                                Pengurusan laporan permohonan boleh dilakukan melalui jadual di bawah.
                            </p>
                        </div>
                    </div>
                    <!-- END card -->
    ...
    <div class="card card-transparent">
        <div class="card-header px-0">
            <div class="card-title">
                ...
                <button onclick="location.href='{{ route('affidavit') }}'" id="" href="javascript:;" class="btn btn-success btn-cons text-capitalize"><i class="fa fa-plus m-r-5"></i> Daftar Kes</button>
                @endif
            </div>
        ...
        <div class="card-block table-responsive">
            <table class="table table-hover" id="table-affidavit">
                <thead>
                    <tr>
                        <th class="fit">Bil.</th>
                        <!-- <th>No Semakan Kehakiman</th> -->
                        <th>Nama Pemohon</th>
...
var settings = {
    ...
    "columns": [
        ...
        // { data: "report.judicial_no", name: "report.judicial_no"},
...
function query(id) {
    $("#modal-div").load("{{ route('affidavit') }}/"+id+"/process/query");
}

function status(id) {
    $("#modal-div").load("{{ route('affidavit') }}/"+id+"/process/status");
}
