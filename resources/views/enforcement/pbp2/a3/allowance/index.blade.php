		...
		<div class="modal-content-wrapper">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="form-add-allowance" role="form" method="post" action="{{ route('pbp2.a3.allowance', [request()->id, $a3->id]) }}">
...
<script type="text/javascript">
	...
	var table1 = $('#table-allowance');

	var settings1 = {
	    "processing": true,
	    "serverSide": true,
	    "deferRender": true,
	    "ajax": "{{ route('pbp2.a3.allowance', [request()->id, $a3->id]) }}",
	    "columns": [
	...
	function editAllowance(id) {
		$("#modal-div").load("{{ route('pbp2.a3.allowance', [request()->id,$a3->id]) }}/"+id);
	}
	...
	function removeAllowance(id) {
	    ...
	    .then((confirm) => {
	        if (confirm) {
	            $.ajax({
	                url: '{{ route('pbp2.a3.allowance', [request()->id,$a3->id]) }}/'+id,
	                method: 'delete',
	                dataType: 'json',
	                async: true,
	                contentType: false,
