		...
		<div class="modal-content-wrapper">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="form-add-incentive" role="form" method="post" action="{{ route('pbp2.a3.incentive', [request()->id, $a3->id]) }}">
...
<script type="text/javascript">
	...
	var settings2 = {
	    ...
	    "serverSide": true,
	    "deferRender": true,
	    "ajax": "{{ route('pbp2.a3.incentive', [request()->id, $a3->id]) }}",
	    "columns": [
	...
	function editIncentive(id) {
		$("#modal-div").load("{{ route('pbp2.a3.incentive', [request()->id,$a3->id]) }}/"+id);
	}
	...
	function removeIncentive(id) {
	    ...
	    .then((confirm) => {
	        if (confirm) {
	            $.ajax({
	                url: '{{ route('pbp2.a3.incentive', [request()->id,$a3->id]) }}/'+id,
	                method: 'delete',
	                dataType: 'json',
	                async: true,
	                contentType: false,
