		...
		<div class="modal-content-wrapper">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="form-edit-incentive" role="form" method="post" action="{{ route('pbp2.a3.incentive.form', [request()->id, request()->a3_id, $incentive->id]) }}">
					...
					<div class="row">
						<div class="col-md-12 p-t-10">
							<button type="button" onclick="submitForm('form-edit-incentive')" class="btn btn-info m-t-5 pull-right"><i class="fa fa-check mr-1"></i> Simpan</button>
						</div>
					</div>
				</div>
			</div>
