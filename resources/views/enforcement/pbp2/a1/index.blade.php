				...
				<div class="col-xl-12 col-lg-12 ">
					...
					<div class="card card-transparent">
						<div class="card-block p-t-0">
							<h3 class='m-t-0'>Pegawai-pegawai Kesatuan Yang Ditemui</h3>
		...
		<div class="modal-content-wrapper">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="form-add" role="form" method="post" action="{{ route('pbp2.a1', request()->id) }}">
...
<script type="text/javascript">
	...
	function edit(id) {
		$("#modal-div").load("{{ route('pbp2.a1', request()->id) }}/"+id);
	}
	...
	function remove(id) {
	    ...
	    .then((confirm) => {
	        if (confirm) {
	            $.ajax({
	                url: '{{ route('pbp2.a1', request()->id) }}/'+id,
	                method: 'delete',
	                dataType: 'json',
	                async: true,
	                contentType: false,
