				...
				<div class="col-xl-12 col-lg-12 ">
					...
					<div class="card card-transparent">
						<div class="card-block p-t-0">
							<h3 class='m-t-0'>Maklumat Pekerja Kesatuan</h3>
    ...
    <div class="card card-transparent">
        <div class="card-header px-0">
            <div class="card-title">
            	<button onclick="location.href='{{ route('pbp2.a4', request()->id) }}'" class="btn btn-primary btn-cons" type="button"><i class="fa fa-plus m-r-5"></i> Tambah Maklumat</button>
            </div>
            ...
            <table class="table table-hover" id="table">
                <thead>
                    <tr>
                        ...
                        <th>Nama</th>
                        <th>Jawatan</th>
                        <th class="fit">Tarikh Lantikan</th>
                        <th>Gaji / Elaun (RM)</th>
                        <th>Insentif Lain</th>
...
<script type="text/javascript">
    ...
    var settings = {
        ...
        "serverSide": true,
        "deferRender": true,
        "ajax": "{{ route('pbp2.a4.list', request()->id) }}",
        "columns": [
            ...
            { data: "allowance", name: "allowance", searchable: false, render: function(data, type, row){
                return $("<div/>").html(data).text();
            }},
            { data: "incentive", name: "incentive", searchable: false, render: function(data, type, row){
                return $("<div/>").html(data).text();
            }},
    ...
    function remove(id) {
        ...
        .then((confirm) => {
            if (confirm) {
                $.ajax({
                    url: '{{ route('pbp2.a4', request()->id) }}/'+id,
                    method: 'delete',
                    dataType: 'json',
                    async: true,
                    contentType: false,
