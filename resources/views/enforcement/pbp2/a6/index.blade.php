				...
				<div class="col-xl-12 col-lg-12 ">
					...
					<div class="card card-transparent">
						<div class="card-block p-t-0">
							<h3 class='m-t-0'>Perjanjian Bersama</h3>
    ...
    <div class="card card-transparent">
        <div class="card-header px-0">
            <div class="card-title">
            	<button onclick="add()" class="btn btn-primary btn-cons" type="button"><i class="fa fa-plus m-r-5"></i> Tambah Perjanjian</button>
            </div>
		...
		<div class="modal-content-wrapper">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="form-add" role="form" method="post" action="{{ route('pbp2.a6', request()->id) }}">
...
<script type="text/javascript">
    ...
    function edit(id) {
        $("#modal-div").load("{{ route('pbp2.a6', request()->id) }}/"+id);
    }
    ...
    function remove(id) {
        ...
        .then((confirm) => {
            if (confirm) {
                $.ajax({
                    url: '{{ route('pbp2.a6', request()->id) }}/'+id,
                    method: 'delete',
                    dataType: 'json',
                    async: true,
                    contentType: false,
