		...
		<div class="modal-content-wrapper">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="form-edit" role="form" method="post" action="{{ route('pbp2.a2.form', [request()->id, $a2->id]) }}">
						...
						<div class="form-group-attached">
							@include('components.input', [
								...
								'label' => 'Alamat 1',
								'mode' => 'required',
								'value' => $a2->address ? $a2->address->address1 : ''
							])
							...
							<div class="row clearfix">
								<div class="col-md-6">
									@include('components.input', [
										'name' => 'address2',
										'label' => 'Alamat 2',
										$a2->address ? $a2->address->address2 : ''
									])
								</div>
								<div class="col-md-6">
									@include('components.input', [
										'name' => 'address3',
										'label' => 'Alamat 3',
										$a2->address ? $a2->address->address3 : ''
									])
								</div>
							</div>
							...
							<div class="row clearfix address">
								<div class="col-md-4">
									<div class="form-group form-group-default required">
										<label>Poskod</label>
										<input class="form-control numeric postcode" name="postcode" aria-required="true" type="text" value="{{ $a2->address->postcode }}" required minlength="5" maxlength="5">
									</div>
								</div>
								<div class="col-md-4">
	                                <div class="form-group form-group-default form-group-default-custom form-group-default-select2 required">
...
$("#edit_state_id").val( {{ $a2->address->state_id }} ).trigger('change');

$("#edit_district_id").val( {{ $a2->address->district_id }} ).trigger('change');

$("#edit_designation_id").val( {{ $a2->designation_id }} ).trigger('change');
</script>
