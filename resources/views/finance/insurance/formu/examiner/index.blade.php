        ...
        <div class="modal-content-wrapper">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-add-examiner" role="form" method="post" action="{{ route('insurance.formu.form.examiner', $insurance->id) }}">
...
var settings = {
    ...
    "serverSide": true,
    "deferRender": true,
    "ajax": "{{ route('insurance.formu.form.examiner', [$insurance->id, $formu->id]) }}",
    "columns": [
...
function editExaminer(id) {
    $("#modal-div").load("{{ route('insurance.formu.form.examiner', $insurance->id) }}/"+id);
}
...
function removeExaminer(id) {
    ...
    .then((confirm) => {
        if (confirm) {
            $.ajax({
                url: '{{ route('insurance.formu.form.examiner', $insurance->id) }}/'+id,
                method: 'delete',
                dataType: 'json',
                async: true,
                contentType: false,
