        ...
        <div class="modal-content-wrapper">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-add-examiner" role="form" method="post" action="{{ route('levy.formu.examiner', $levy->id) }}">
...
var settings = {
    ...
    "serverSide": true,
    "deferRender": true,
    "ajax": "{{ route('levy.formu.examiner', $levy->id) }}",
    "columns": [
...
function editExaminer(id) {
    $("#modal-div").load("{{ route('levy.formu.examiner', $levy->id) }}/"+id);
}
...
function removeExaminer(id) {
    ...
    .then((confirm) => {
        if (confirm) {
            $.ajax({
                url: '{{ route('levy.formu.examiner', $levy->id) }}/'+id,
                method: 'delete',
                dataType: 'json',
                async: true,
                contentType: false,
