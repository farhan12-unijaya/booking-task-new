		...
		<div class="modal-content-wrapper">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="form-edit-officer" class="is-icpassport" role="form" method="post" action="{{ route('formlu.officer.form', [$formlu->id, $officer->id]) }}">
							...
							<div class="row">
								<div class="col-md-12">
									@include('components.date', [
										...
										'value' => $officer->held_at ? date('d/m/Y', strtotime($officer->held_at)) : date('d/m/Y'),
									])
								</div>
							</div>
						</div>
