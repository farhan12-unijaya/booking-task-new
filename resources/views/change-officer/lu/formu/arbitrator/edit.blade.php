        ...
        <div class="modal-content-wrapper">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-edit-arbitrator" role="form" method="post" action="{{ route('formlu.examiner.form', [ request()->id, $examiner->id]) }}">
                ...
                <div class="modal-footer">  
                    <div class="col-md-12 p-t-10">
                        <button type="button" class="btn btn-info m-t-5 pull-right submit" onclick="submitForm('form-edit-arbitrator')"><i class="fa fa-check" ></i> Simpan</button>                
                    </div>
                </div>
            </div>
        </div>
