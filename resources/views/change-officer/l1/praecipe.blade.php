...
<body class="letter">
	...
	<div class="left">Yuran dibayar dengan setem yang belum dibatalkan <strong>RM 1.00</strong></div>
	<div class="left">Nama Kesatuan Sekerja <strong>{{ $forml1->tenure->entity->name }}</strong></div><br><br><br>
	<table>
		<tr>
			<td></td>
