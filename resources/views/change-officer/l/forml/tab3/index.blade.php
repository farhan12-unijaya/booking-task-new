		...
		<div class="modal-content-wrapper">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="form-add-officer" class="is-icpassport" role="form" method="post" action="{{ route('forml.officer', $forml->id) }}">
...
<script>
	...
	var settings2 = {
	    ...
	    "serverSide": true,
	    "deferRender": true,
	    "ajax": "{{ route('forml.officer', $forml->id) }}",
	    "columns": [
	...
	function editOfficer(id) {
		$("#modal-div").load("{{ route('forml.officer', $forml->id) }}/"+id);
	}
	...
	function removeOfficer(id) {
	    ...
	    .then((confirm) => {
	        if (confirm) {
	            $.ajax({
	                url: '{{ route('forml.officer', $forml->id) }}/'+id,
	                method: 'delete',
	                dataType: 'json',
	                async: true,
	                contentType: false,
