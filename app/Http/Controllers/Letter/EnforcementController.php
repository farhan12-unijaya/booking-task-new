...
class EnforcementController extends Controller
{
    ...
    public function letter(Request $request) {
        ...
        $data = array_merge($data, [
            ...
            'chairman_name' => htmlspecialchars(strtoupper($letter->entity->tenures->last()->officers()->where('designation_id', 1)->first()->name)),
            'treasurer_name' => htmlspecialchars(strtoupper($letter->entity->tenures->last()->officers()->where('designation_id', 5)->first()->name)),
            // '' => htmlspecialchars(),
        ]);
    ...
    public function notice(Request $request) {
        ...
        $suggestions = array_filter(preg_split('~\R~u', $extras));
