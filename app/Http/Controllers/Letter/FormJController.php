...
class FormJController extends Controller
{
    ...
    public function pnmb(Request $request) {
        ...
        $data = array_merge($data, [
            ...
            'new_address' => htmlspecialchars($letter->entity->filing->new_address->address1).
                ($letter->entity->filing->new_address->address2 ? ',<w:br/>'.htmlspecialchars($letter->entity->filing->new_address->address2) : '').
                ($letter->entity->filing->new_address->address3 ? ',<w:br/>'.htmlspecialchars($letter->entity->filing->new_address->address3) : ''),
            'new_postcode' => htmlspecialchars($letter->entity->filing->new_address->postcode),
            'new_district' => $letter->entity->filing->new_address->district ? htmlspecialchars($letter->entity->filing->new_address->district->name) : '',
            'new_state' => $letter->filing->new_address->state ? htmlspecialchars($letter->entity->filing->new_address->state->name) : '',
