...
class RoomCategoryController extends Controller
{
    ...
    public function index(Request $request) {
        ...
        if($request->ajax()) {
            ...
            $log->description = "Papar senarai Data Induk - Kategori Room";
            ...
            $type = MasterRoomCategory::orderBy('id');
            ...
            $log->description = "Buka paparan Data Induk - Kategori Room";
            $log->url = $request->fullUrl();
            $log->method = strtoupper($request->method());
            $log->ip_address = $request->ip();
            $log->created_by_user_id = auth()->id();
        ...
        return view('admin.master.room-category.index');
    }
    ...
    public function insert(Request $request)
    {
        ...
        $type = MasterRoomCategory::create($request->only('name'));

        $log = new LogSystem;
        $log->module_id = 50;
        $log->activity_type_id = 4;
        $log->description = "Tambah Data Induk - Kategori Room";
    ...
    public function edit(Request $request)
    {
        ...
        $log->description = "Popup kemaskini Data Induk - Kategori Room";
        $log->url = $request->fullUrl();
        $log->method = strtoupper($request->method());
        $log->ip_address = $request->ip();
        $log->created_by_user_id = auth()->id();
        ...
        $type = MasterRoomCategory::findOrFail($request->id);

        return view('admin.master.room-category.edit', compact('type'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $log->description = "Kemaskini Data Induk - Kategori Room";
    ...
    public function delete(Request $request)
    {
        ...
        $log->description = "Padam Data Induk - Kategori Room";
        $log->data_old = json_encode($type);
        $log->url = $request->fullUrl();
        $log->method = strtoupper($request->method());
        $log->ip_address = $request->ip();
